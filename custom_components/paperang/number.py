...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities(
        [
            PaperangNumber(
                coordinator, device_id, device_info, "font_size", "Font Size",
            ...
            PaperangNumber(
                coordinator, device_id, device_info, "qr_size", "QR Size",
                num_range=NumberRange(
            ...
            PaperangNumber(
                coordinator, device_id, device_info, "feed_lines", "Feed Lines",
                num_range=NumberRange(
...
class PaperangNumber(PaperangEntity, NumberEntity):
    ...
    def __init__(
        ...
        key: str, name: str, *, num_range: NumberRange,
    ) -> None:
        """Initialize."""
        super().__init__(
