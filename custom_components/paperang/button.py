...
class PaperangPrintButton(PaperangEntity, ButtonEntity):
    ...
    def __init__(self, coordinator, entry_id, device_info) -> None:
        """Initialize."""
        super().__init__(
            coordinator, entry_id, "Print", "btn_print", "mdi:printer",
    ...
    async def async_press(self) -> None:
        ...
        if (state := hass.states.get(
            f"number.paperang_{eid}_font_size"
        )) is not None:
        ...
        if (state := hass.states.get(
            f"number.paperang_{eid}_qr_size"
        )) is not None:
...
class PaperangFeedButton(PaperangEntity, ButtonEntity):
    ...
    def __init__(self, coordinator, entry_id, device_info) -> None:
        """Initialize."""
        super().__init__(
            coordinator, entry_id, "Feed Paper", "btn_feed_paper",
    ...
    async def async_press(self) -> None:
        ...
        if (state := self.hass.states.get(
            f"number.paperang_{eid}_feed_lines"
        )) is not None:
...
class PaperangTestPrintButton(PaperangEntity, ButtonEntity):
    ...
    def __init__(self, coordinator, entry_id, device_info) -> None:
        """Initialize."""
        super().__init__(
            coordinator, entry_id, "Test Print", "btn_test_print",
